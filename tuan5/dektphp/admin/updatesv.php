    ...
    if (isset($_REQUEST["mssv"])) {
        ...
        if ($conn) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $_SESSION['message_updatesv'] = "Không tìm thấy sinh viên có mssv " . $mssv . " cần sửa!";
            }
        }
    } else {
        $_SESSION['message_updatesv'] = "Không tìm thấy mssv cần sửa!";
    }
}
if (isset($_POST["btnSubmit"])) {
    ...
    if ($conn) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            header("Location: " . INDEX_URL . "admin/updatesv.php?mssv=" . $mssv);
            exit();
        } else {
